    ...
    <div className="fui-panel clip-angular p-4">
      <div className="flex items-center justify-between mb-2 px-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] font-mono text-slate-400 tracking-[0.2em]">AUDIO SIGNATURE RADAR</span>
        </div>
        <span className="text-[9px] font-mono text-accent-cyan/50 tracking-wider">AVERAGE FEATURES BY TIME RANGE</span>
      </div>
