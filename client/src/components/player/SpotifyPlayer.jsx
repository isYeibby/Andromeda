    ...
    return (
      <div className="fixed bottom-0 left-0 right-0 z-40 fui-panel border-t border-accent-cyan/20">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-center gap-2">
          <div className="w-2 h-2 bg-accent-amber animate-pulse rounded-full" />
      ...
      <div className="max-w-7xl mx-auto px-4 py-2">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={togglePlay}
              className="w-10 h-10 clip-angular-sm flex items-center justify-center bg-accent-fuchsia/20 border border-accent-fuchsia/40 
                         hover:bg-accent-fuchsia/30 hover:shadow-neon-fuchsia transition-all duration-300"
          ...
          <div className="flex items-center gap-2 flex-1 max-w-md">
            ...
            <div className="flex-1 relative group">
              ...
              />
              <div
                className="absolute top-1/2 left-0 h-[4px] -translate-y-1/2 bg-gradient-to-r from-accent-fuchsia to-accent-cyan pointer-events-none rounded"
